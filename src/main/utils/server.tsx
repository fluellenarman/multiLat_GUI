...
async function sendDroneLocRedGUI(loc) {
	...
	try {
		...
		let redIP = discoveryNetwork.peers.get('red-gui')
		if (redIP) {
			targetURL = `${redIP}/droneLoc`
			console.log('Using network URL: ', redIP)
		}
